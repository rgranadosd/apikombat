...
try:
    # Importar desde nuestro engine primero (necesario para type hints)
    sys.path.insert(0, project_root)
    from engine import Carta, Jugador, ASPECTOS, ASPECTO_MAP
    
    # Importar desde nuestro api-card-game (que extiende MTG)
    from api.game_api import APIGame
    from api.aspecto import AspectoPermanent
    from api.card_generator import create_deck_from_cartas, create_mtg_card_instance
    MTG_AVAILABLE = True
